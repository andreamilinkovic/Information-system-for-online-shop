...
@NamedQueries({
    ...
    @NamedQuery(name = "KorpaArtikal.findBySifA", query = "SELECT k FROM KorpaArtikal k WHERE k.sifA = :sifA"),
...
public class KorpaArtikal implements Serializable {
    ...
    public KorpaArtikal(Integer sifKA, int kolicina, int sifA, BigDecimal cena) {
        this.sifKA = sifKA;
